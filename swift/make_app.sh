...
# The Agent Baltic mark shown in the window header (BrandLogo in ContentView).
if [ -f "$REPO/assets/agentbaltic-logo.png" ]; then
    cp "$REPO/assets/agentbaltic-logo.png" "$APP/Contents/Resources/agentbaltic-logo.png"
fi
